...
def update_stages_for_resolved_records():
    ...
    resolved_docs = list(tickets_new_collection.find(query))
    ...
    for i, doc in enumerate(resolved_docs):
        ...
        # Update the document
        tickets_new_collection.update_one(
            {'_id': doc['_id']},
...
def update_stages_for_pending_records():
    ...
    pending_docs = list(tickets_new_collection.find(query))
...
def verify_stages_distribution():
    ...
    resolved_docs = list(tickets_new_collection.find(resolved_query))
    ...
    pending_docs = list(tickets_new_collection.find(pending_query))
    ...
    all_docs = list(tickets_new_collection.find({}))
