...
def update_stages_for_resolved_records():
    ...
    resolved_docs = list(chat_new_collection.find(query))
...
def update_stages_for_pending_records():
    ...
    pending_docs = list(chat_new_collection.find(query))
...
def verify_stages_distribution():
    ...
    resolved_docs = list(chat_new_collection.find(resolved_query))
    ...
    pending_docs = list(chat_new_collection.find(pending_query))
    ...
    all_docs = list(chat_new_collection.find({}))
