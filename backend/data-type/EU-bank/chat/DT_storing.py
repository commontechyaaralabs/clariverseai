...
COLLECTION_NAME = "chat-chunks"  # Changed from emailmessages to chat-chunks
...
def main():
    ...
    logger.info("Starting chat-chunks collection update with topic data...")
    
    # Initialize processors
    mongo_processor = MongoDBProcessor()
    csv_processor = CSVProcessor("chat.csv")  # Update path as needed
    ...
    try:
        ...
        # Generate topic combinations (limited to 600)
...
def check_collection_status():
    """Check the current status of the chat-chunks collection"""
    mongo_processor = MongoDBProcessor()
    try:
        if mongo_processor.connect():
            ...
            if count > 0:
                ...
                print(f"\nCollection Status:")
                print(f"- Documents in chat-chunks: {count}")
...
if __name__ == "__main__":
    print("Chat-Chunks Topic Setup Tool")
    print("=" * 40)
    ...
    if choice == "1":
        ...
        preview_csv_combinations("chat.csv", 15, MAX_COMBINATIONS)
    elif choice == "2":
