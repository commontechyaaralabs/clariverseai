...
COLLECTION_NAME = "twitter"  # Changed from emailmessages to twitters
...
def main():
    ...
    csv_processor = CSVProcessor("twitter.csv")  # Update path as needed
...
if __name__ == "__main__":
    ...
    if choice == "1":
        ...
        preview_csv_combinations("twitter.csv", 15, MAX_COMBINATIONS)
    elif choice == "2":
