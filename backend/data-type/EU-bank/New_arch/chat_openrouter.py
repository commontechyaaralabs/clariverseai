# EU Banking Chat Messages Generation and Analysis System
import os
import random
import time
import json
...
13. **Chat Timing:** Use realistic chat response times (seconds to minutes, not hours like email)
14. **Message Length:** Keep individual messages chat-appropriate (50-150 words, with natural variation)
15. **EMOTION DETECTION:** Pay special attention to banking-related emotional triggers (account problems, security concerns, successful transactions) and how they manifest in chat conversations
